...
| **Parametric Contour Plots** | *Always Active* | Renders 2D parametric curves and contour plots analyzing key design tradeoffs (e.g., dish diameter vs. frequency, EIRP vs. system noise temperature, HPA power vs. GS1 dish diameter). | **Core Requirement** |
| **ITU-R Slant-Path Propagation** | `ITU_PROPAGATION` | Detailed atmospheric attenuation modeling based on ITU-R P.618-13, P.837 rainfall-rate input, P.838 rain specific attenuation, P.676 gas absorption, and P.840 cloud liquid water. | **Advanced Feature** |
